...
2. strcat 의 용법은 아래와 같다.
    ...
    사. 문자열 붙이기를 하려면 char배열 또는 char형으로 선언된 동적 메모리 변수를 이용하면 된다. 이 둘의 장단점을 비교해 보시오.
        마찬가지로, []로 문자열에 붙이기를 하려거든 용량을 넘지 않도록 주의해야 한다.
